...
set output "gh_openMPI_cq.eps"

set size square .66

set title " Commit Quality - openMPI"
...
#set xtics ( "2003" 1, "2004" 2, "2005" 3, "2006" 4, "2007" 5, "2008" 6,\
#             "2009" 7, "2010" 8, "2011" 9, "2012" 10, "2013" 11, "2014" 12)
set xtics (  "2004" 2, "2006" 4, "2008" 6, "2010" 8, "2012" 10,"2014" 12)
#set xtics (  "2003" 1, "2005" 3, "2007" 5, "2009" 7, "2011" 9, "2013" 11, "2015" 13)
#set xtics (  "2004" 1, "2006" 2, "2008" 3, "2010" 4, "2012" 5, "2014" 6)
...
#error(x, dx, y, dy)=(x/y) * sqrt( (dx/x)**2.0 + (dy/y)**2.0 )
   ...
   plot "gh_openMPI.txt" using 1:3 title "nTC" with linespoints ls 4 axes x1y1,\
        "" using 1:4 title "nUC" with linespoints ls 5 axes x1y1, \
        "" using 1:5 title "nUC/nTC Ratio" with linespoints ls 6 axes x1y2


!epstopdf gh_openMPI_cq.eps && rm gh_openMPI_cq.eps
